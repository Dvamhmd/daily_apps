        ...
        child: ResponsiveContentWrapper(
          ...
          child: Column(
            ...
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (targetDate != null) ...[
                      ...
                      Text(
                        'Target Deadline: ${DateFormat('dd MMMM yyyy').format(targetDate!)}',
                        style: TextStyle(
                          fontSize: 11.5,
                          color: Colors.grey[600],
                        ),
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          'Terkumpul: ${RupiahFormatter.format(totalTabungan)}',
                          style: TextStyle(
                            fontSize: 11.5,
                            color: Colors.grey[600],
                            fontWeight: FontWeight.w500,
              ...
              // TABUNGANKU (LIST REALISASI TABUNGAN)
              InfoCardTabungan(
                title: 'Tabunganku',
