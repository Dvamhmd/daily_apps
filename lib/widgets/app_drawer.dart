...
class AppDrawer extends StatelessWidget {
            ...
            child: ListView(
              ...
              children: [
                ...
                _buildMenuItem(
                  ...
                  subtitle: 'Proporsi alokasi & kesehatan dana',
                  onTap: () {
                    Navigator.pop(context);
                    _showAnalisisDialog(context, status);
                  },
                ),
              ],
            ),
  ...
  void _showAnalisisDialog(BuildContext context, StatusKesehatan status) {
    final totalDana = totalUangku + totalTabungan;
    final rasioTagihan =
        totalUangku > 0 ? ((totalTagihan / totalUangku) * 100).round() : 0;
    final rasioTabungan =
        totalDana > 0 ? ((totalTabungan / totalDana) * 100).round() : 0;
      ...
      builder: (ctx) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 14),
            _buildRasioItem(
              title: 'Beban Tagihan vs Uangku',
              value: '$rasioTagihan%',
              desc: rasioTagihan > 50
                  ? '⚠️ Beban tagihan di atas 50% saldo uang aktif!'
                  : '✅ Beban tagihan dalam batas wajar.',
              progress: (rasioTagihan / 100).clamp(0.0, 1.0),
              progressColor: rasioTagihan > 50
                  ? const Color(0xFFD46A6A)
                  : const Color(0xFF2E7D32),
            ),
            const SizedBox(height: 12),
            _buildRasioItem(
              title: 'Rasio Tabungan vs Total Aset',
              value: '$rasioTabungan%',
              desc: 'Porsi dana yang telah diamankan ke pos tabungan.',
              progress: (rasioTabungan / 100).clamp(0.0, 1.0),
              progressColor: const Color(0xFF5E35B1),
            ),
            const SizedBox(height: 16),
            Text(
              'Rincian Saldo Keseluruhan:',
              style: GoogleFonts.poppins(
                fontSize: 12,
                fontWeight: FontWeight.w600,
                color: Colors.grey[700],
            ...
            const SizedBox(height: 8),
            _buildDetailRow('Total Saldo Uangku', totalUangku, const Color(0xFF1976D2)),
            _buildDetailRow('Total Tagihan Aktif', totalTagihan, const Color(0xFFD46A6A)),
            _buildDetailRow('Sisa Dana Aman', totalUangku - totalTagihan, const Color(0xFF2E7D32)),
            _buildDetailRow('Total Tabungan Terkumpul', totalTabungan, const Color(0xFF5E35B1)),
          ],
        ),
      ),
    );
