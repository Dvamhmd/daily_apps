                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              'Rincian Item Pengeluaran ($totalItems)',
                              style: const TextStyle(
                                fontSize: 14,
                                fontWeight: FontWeight.bold,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: Text(
                            isRealized ? 'Terealisasi' : 'Estimasi',
                            style: TextStyle(
                              fontSize: 10,
                              fontWeight: FontWeight.bold,
                              color: isRealized
          ...
          // Nominal Breakdown & Action Button
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Column(
                ...
                children: [
                  Text(
                    'Estimasi: Rp ${RupiahFormatter.format(estimasi)}',
                    style: TextStyle(
                      fontSize: 12,
                      fontWeight: FontWeight.w600,
                      color: isRealized
                      ...
                      decoration:
                          isRealized ? TextDecoration.lineThrough : null,
                    ),
                  ),
                  if (isRealized && realisasi != null) ...[
                    const SizedBox(height: 3),
                    Row(
                      children: [
                        Text(
                          'Realisasi: Rp ${RupiahFormatter.format(realisasi)}',
                          style: const TextStyle(
                            fontSize: 14,
                            fontWeight: FontWeight.bold,
                        ...
                        if (selisihItem != 0)
                          Container(
                            ...
                            child: Text(
                              selisihItem > 0
                                  ? 'Hemat ${RupiahFormatter.format(selisihItem)}'
                                  : '+${RupiahFormatter.format(selisihItem.abs())}',
                              style: TextStyle(
                                fontSize: 10,
                                fontWeight: FontWeight.bold,
                                color: selisihItem > 0
              ...
              if (!isRealized)
                ...
                OutlinedButton.icon(
                  onPressed: () => _batalkanRealisasi(item, index),
                  style: OutlinedButton.styleFrom(
